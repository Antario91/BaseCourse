 ...
 *         &lt;element name="newOrderItems" type="{http://www.order.dtos.webService/}OrderItemDTO" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class UpdatedOrderDTO {
    ...
    protected List<OrderItemDTO> newOrderItems;
     ...
     * 
     */
    public List<OrderItemDTO> getNewOrderItems() {
        if (newOrderItems == null) {
            newOrderItems = new ArrayList<OrderItemDTO>();
        }
